...
from branch_tui import (BLUE, CYAN, Node, TerminalSession, TreeBrowser, git,
                        in_git_repo, is_file_node, repo_toplevel,
...
class GrepBrowser(TreeBrowser):
    ...
    def _empty_hint(self):
        return "  (matches appear here)" if not self.matches else ""
